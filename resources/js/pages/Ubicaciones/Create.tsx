...
export default function UbicacionesCreate({ secciones }: { secciones: SeccionRef[] }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        columna: '',
        nivel: '',
        capacidad_maxima: '' as string | number,
        activo: true,
    });
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post('/ubicaciones', {
            transform: (d) => ({
                ...d,
                id_seccion: d.id_seccion ? Number(d.id_seccion) : null,
    ...
    return (
        <AppLayout title="Nueva ubicación">
