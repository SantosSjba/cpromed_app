...
export default function LaboratoriosEdit({ laboratorio }: { laboratorio: Laboratorio }) {
    const { data, setData, put, processing, errors } = useForm({
        nombre: laboratorio.nombre,
        pais_origen: laboratorio.pais_origen || '',
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/laboratorios/${laboratorio.id_laboratorio}`);
    };

    return (
        <AppLayout title="Editar laboratorio">
            <Head title="Editar laboratorio" />
