...
export default function CategoriasIndex({
    ...
    const submitSearch = (e: FormEvent) => {
        e.preventDefault();
        get('/categorias', { buscar: data.buscar }, { preserveState: true });
    };

    return (
        <AppLayout title="Categorías de medicamentos">
                                ...
                                categorias.data.map((c) => (
                                    <tr key={c.id_categoria} className="hover:bg-slate-50">
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <Link
                                                href={`/categorias/${c.id_categoria}/edit`}
