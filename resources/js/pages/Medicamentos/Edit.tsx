...
export default function MedicamentosEdit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        codigo_digemid: medicamento.codigo_digemid || '',
        codigo_interno: medicamento.codigo_interno,
        ...
        temperatura_almacenamiento: medicamento.temperatura_almacenamiento || '',
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/medicamentos/${medicamento.id_medicamento}`, {
            transform: (d) => ({
                ...d,
                ...
                <form onSubmit={submit} className="space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" value={data.concentracion} onChange={(e) => setData('concentracion', e.target.value)} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" />
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                    ...
                    <div>
                        ...
                        <input type="text" value={data.temperatura_almacenamiento} onChange={(e) => setData('temperatura_almacenamiento', e.target.value)} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" />
                    </div>
                    <div>
