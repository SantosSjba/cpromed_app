...
class UpdateMedicamentoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'codigo_digemid' => ['nullable', 'string', 'max:50', Rule::unique('medicamentos', 'codigo_digemid')->ignore($medicamento->id_medicamento, 'id_medicamento')],
            'codigo_interno' => ['required', 'string', 'max:50', Rule::unique('medicamentos', 'codigo_interno')->ignore($medicamento->id_medicamento, 'id_medicamento')],
